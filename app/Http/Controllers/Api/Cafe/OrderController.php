...
// 			}
			...
			$payable_amount = $request->tax_amount + $total_amount;
			...
			foreach ($request->order_details as $key => $value) {
				...
				$discount_amount =0;
				if(@$value['is_discount'] == true){
					$discount_amount = (@$value['total']*$discount_per)/100;
				...
				$orderDetail->discount_per = $discount_per;
